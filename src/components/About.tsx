        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              ...
              ear, nose, and throat healthcare. We combine clinical expertise with patient education to 
              deliver treatment plans that address each individual's unique needs.
            </p>
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              ...
              through accurate diagnosis and personalized care.
            </p>
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              Through our health education resources and digital consultations, we extend our expertise 
              beyond physical boundaries, making professional ENT guidance accessible to patients worldwide.
            </p>
