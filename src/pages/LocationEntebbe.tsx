...
import { MapPin, Phone, Clock, Star, ExternalLink, Navigation, CheckCircle } from "lucide-react";
...
const LocationEntebbe = () => {
  ...
  const localBusinessSchema = {
    ...
    "description": "Professional ENT clinic in Entebbe offering expert ear, nose, and throat care including hearing tests, sinus treatment, tonsillitis care, and emergency ENT services.",
  ...
  return (
    <>
      <Helmet>
        <title>Eritage ENT Care – Entebbe | ENT Clinic in Entebbe, Uganda</title>
        <meta name="description" content="Visit Eritage ENT Care in Entebbe for expert ear, nose, and throat treatment. Located along Entebbe Road with hearing tests, sinus care, and urgent ENT services. Call +256 740 166 778." />
        <meta name="keywords" content="ENT clinic Entebbe, ear doctor Entebbe, ENT specialist Entebbe, hearing test Entebbe, sinus treatment Entebbe, throat doctor Entebbe Uganda" />
        <meta property="og:title" content="Eritage ENT Care – Entebbe | ENT Clinic in Entebbe" />
        <meta property="og:description" content="Expert ENT care in Entebbe. Comprehensive ear, nose, and throat services along Entebbe Road." />
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
              ...
              <div>
                <Card className="h-full">
                  <CardContent className="p-8">
                    <h2 className="text-2xl font-serif font-bold mb-6">Clinic Information</h2>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground">
                            Available 24/7 for consultations<br />
              ...
              {/* Services */}
              <div>
                <h2 className="text-2xl font-serif font-bold mb-6">Services at This Location</h2>
                ...
                <p className="mt-6 text-muted-foreground">
                  Our Entebbe clinic serves patients from across the Central Region, including areas along the Kampala-Entebbe corridor. We offer same-day appointments for urgent ENT concerns.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-muted-foreground">
                Located along Entebbe Road for easy access
              </p>
            </div>
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl font-serif font-bold mb-6">Why Choose Our Entebbe Clinic?</h2>
              <div className="grid md:grid-cols-3 gap-8 mt-10">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">
                    Easy access along Entebbe Road, serving patients from Kampala, Entebbe, and surrounding areas.
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">
                    24/7 availability with same-day appointments for urgent ENT concerns.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-primary/5">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl md:text-3xl font-serif font-bold mb-4">
              Ready to Visit Our Entebbe Clinic?
            </h2>
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              Book your appointment today and experience expert ENT care at our flagship Entebbe location.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" asChild className="gap-2">
                <a href="tel:+256740166778">
              ...
              <Button size="lg" variant="outline" asChild className="gap-2">
                <a 
                  href="https://wa.me/256740166778?text=Hello%2C%20I%20would%20like%20to%20book%20an%20appointment%20at%20the%20Entebbe%20clinic." 
                  target="_blank" 
                  rel="noopener noreferrer"
                >
                  Book via WhatsApp
